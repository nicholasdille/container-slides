...
We will learn how to execute pipeline regularly, e.g. for daily or weekly rebuilds.
...
Create a schedule to run every 10 minutes on the branch `main` in the your timezone. See the official documentation for [schedules](https://docs.gitlab.com/ee/ci/pipelines/schedules.html).
